...
module ActiveSupport
  # Extension to the TimeWithZone class for iCalendar support.
  class TimeWithZone < Object
    ...
    # Should immediately follow an iCalendar field name
    # (such as “DTSTART” — don’t include colon or other separateor after).
