Feature: Events
  ...
  Scenario: Admin adds an event
    ...
    And I fill in "event_title" with "New Admin Event"
    And I fill in "event_description" with "This is an event, newly posted by an admin."
  ...
  Scenario: Admin updates an event
    ...
    And I follow "Edit"
    And I fill in "event_title" with "Updated Event"
    And I press "Save Event"
