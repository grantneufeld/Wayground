...
describe Wayground::Democracy::CandidateForm do
  before(:all) do
    ...
    @duplicate_person = FactoryGirl.create(
      :person, filename: 'duplicate_person', fullname: 'Duplicate Person'
    )
    ...
    context 'with valid parameters set' do
      ...
      context 'with an existing person' do
        it 'should assign the attributes' do
          existing_person = FactoryGirl.create(
            :person, filename: 'existing_person', fullname: 'Existing Person', bio: nil
          )
          form = Wayground::Democracy::CandidateForm.new
          form.ballot = ballot
      ...
      context 'with an existing candidate' do
        it 'should assign the attributes' do
          existing_candidate = FactoryGirl.create(
            :candidate, filename: 'existing_candidate', name: 'Existing Candidate'
          )
          form = Wayground::Democracy::CandidateForm.new
          form.ballot = ballot
