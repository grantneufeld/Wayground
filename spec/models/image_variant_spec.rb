  ...
  describe 'scopes' do
    ...
    describe '.largest' do
      it 'should order the results from largest to smallest' do
        ...
        v1 = image.image_variants.new(
          url: 'http://a.tld', style: 'scaled', format: 'png', height: 10, width: 20
        )
        v2 = image.image_variants.new(
          url: 'http://b.tld', style: 'scaled', format: 'png', height: 100, width: 200
        )
        v3 = image.image_variants.new(
          url: 'http://c.tld', style: 'scaled', format: 'png', height: 20, width: 40
        )
        v4 = image.image_variants.new(
          url: 'http://d.tld', style: 'scaled', format: 'png', height: 50, width: 100
        )
        image.save!
