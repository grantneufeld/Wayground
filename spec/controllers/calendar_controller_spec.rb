...
describe CalendarController, type: :controller do
  before(:all) do
    ...
    @e1 = FactoryGirl.create(
      :event,
      user: creator, start_at: '2003-12-31 11:00PM', end_at: '2003-12-31 11:59:59PM'
    )
    @e2 = FactoryGirl.create(
      :event,
      user: creator, start_at: '2004-01-01 00:00AM', end_at: '2004-01-01 01:00AM'
    )
    @e3 = FactoryGirl.create(
      :event,
      user: creator, start_at: '2004-02-28 11:00PM', end_at: '2004-02-28 11:59:59PM'
    )
    @e4 = FactoryGirl.create(
      :event,
      user: creator, start_at: '2004-02-29 00:00AM', end_at: '2004-02-29 01:00AM'
    )
    @e5 = FactoryGirl.create(
      :event,
      user: creator, start_at: '2004-02-29 11:00PM', end_at: '2004-02-29 11:59:59PM'
    )
    @e6 = FactoryGirl.create(
      :event,
      user: creator, start_at: '2004-03-01 00:00AM', end_at: '2004-03-01 01:00AM'
    )
    @e97 = FactoryGirl.create(
      :event,
      user: creator, start_at: '2004-12-31 11:00PM', end_at: '2004-12-31 11:59:59PM'
    )
    @e98 = FactoryGirl.create(
      :event,
      user: creator, start_at: '2005-01-01 00:00AM', end_at: '2005-01-01 01:00AM'
    )
    @e99 = FactoryGirl.create(
      :event,
      user: creator, start_at: '2005-02-28 00:00AM', end_at: '2005-02-28 01:00AM'
    )
  end
  ...
  describe "GET 'month'" do
    it 'should return http success' do
      get :month, params: { year: '2000', month: '04' }
      expect(response).to be_success
    end
    ...
    it 'should set the month' do
      get :month, params: { year: '2000', month: '05' }
    ...
    it 'should grab all the relevant events' do
      get :month, params: { year: '2004', month: '02' }
  ...
  describe "GET 'day'" do
    it 'should return http success' do
      get :day, params: { year: '2000', month: '01', day: '01' }
      expect(response).to be_success
    end
    ...
    it 'should set the month' do
      get :day, params: { year: '2000', month: '04', day: '01' }
      expect(assigns(:date).month).to eq 4
    end
    it 'should set the day' do
      get :day, params: { year: '2000', month: '01', day: '06' }
    ...
    it 'should grab all the relevant events' do
      get :day, params: { year: '2004', month: '02', day: '29' }
    ...
    it 'should handle a day in February on a non-leap year' do
      get :day, params: { year: '2005', month: '02', day: '28' }
      expect(response).to be_success
    end
    it 'should handle a day in a month with just 30 days' do
      get :day, params: { year: '2004', month: '06', day: '30' }
      expect(response).to be_success
    end
    context 'with an invalid date' do
      it 'should return a 404 for April 31' do
        get :day, params: { year: '2004', month: '04', day: '31' }
        expect(response.status).to eq 404
      end
      it 'should return a 404 for February 29, 2005' do
        get :day, params: { year: '2005', month: '02', day: '29' }
        expect(response.status).to eq 404
      end
    end
  end
