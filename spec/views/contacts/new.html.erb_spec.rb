...
describe 'contacts/new.html.erb', type: :view do
  ...
  it 'renders new contact form' do
    assert_select 'form', action: '/person/prsn/contacts', method: 'put' do
      ...
      assert_select 'input#contact_is_public', name: 'contact[is_public]'
      assert_select 'input#contact_confirmed_at', name: 'contact[confirmed_at]', type: 'datetime'
      assert_select 'input#contact_expires_at', name: 'contact[expires_at]', type: 'datetime'
