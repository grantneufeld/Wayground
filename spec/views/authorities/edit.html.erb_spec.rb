...
describe 'authorities/edit.html.erb', type: :view do
  before(:each) do
    @authority = assign(
      :authority,
      stub_model(
        Authority,
        user: nil, item: nil, area: 'MyString', is_owner: false,
        can_create: false, can_view: false, can_update: false, can_delete: false,
        can_invite: false, can_permit: false, can_approve: false
      )
    )
  end
