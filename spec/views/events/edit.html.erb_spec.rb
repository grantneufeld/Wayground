...
describe 'events/edit.html.erb', type: :view do
  before(:each) do
    @event = assign(
      ...
      stub_model(
        Event,
        user: nil, start_at: Time.zone.parse('June 12, 2015 at 11:30 AM'), end_at: '',
        is_allday: false, is_draft: false, is_approved: false, is_wheelchair_accessible: false,
        is_adults_only: false, is_tentative: false, is_cancelled: false, is_featured: false,
        title: 'MyString', description: 'MyString', content: 'MyText',
        organizer: 'MyString', organizer_url: 'MyString',
        location: 'MyString', address: 'MyString',
        city: 'MyString', province: 'MyString', country: 'MyString', location_url: 'MyString'
      )
    )
  end
