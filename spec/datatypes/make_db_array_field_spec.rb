...
describe 'make_db_array_field' do
  ...
  describe '_before_type_cast method' do
    it 'should return the value as a user-readable string' do
      person = Person.new(aliases: %w(K L))
      expect( person.aliases_before_type_cast ).to eq 'K, L'
    end
  end
end
